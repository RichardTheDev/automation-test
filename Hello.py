            ...
            for uploaded_pdf in uploaded_pdfs:
                ...
                if response_data:
                    ...
                    try:
                        ...
                        # Handle the exception if the data is not valid JSON
                        st.error(f"Failed to parse the text from {uploaded_pdf.name} as JSON.")

                else:
                    st.error(f"Failed to process the text from {uploaded_pdf.name}.")

            # Display and export the results as a JSON list
            st.json(results)
